...
\begin{center}
\large
\textbf{Filière : Réseaux et Télécommunications}\\
\textbf{Sujet : Implémentation d'une solution VoIP basée sur SIP/RTP}\\
\vspace{0.5cm}
\textbf{Encadrant :} ................................................
\end{center}
...
\begin{figure}[H]
\centering
\IfFileExists{screenshots/app_functionnelle.png}{
    \includegraphics[width=0.9\textwidth]{screenshots/app_functionnelle.png}
}{
    \fbox{\parbox{0.9\textwidth}{
    \centering
    \vspace{1cm}
    Placeholder capture d'écran.\\
    Ajouter le fichier : \texttt{docs/screenshots/app\_fonctionnelle.png}
    \vspace{1cm}
    }}
}
\caption{Interface graphique du client VoIP en fonctionnement.}
\end{figure}
